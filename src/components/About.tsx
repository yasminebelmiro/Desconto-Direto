...
const About = () => {
  return (
    <section>
      <div className="p-20 lg:px-40 bg-light-organge flex flex-col md:flex-row bg-light-orange justify-center items-center gap-10">
        <div className="flex flex-col items-start text-center gap-5">
          <h3 className="font-kaisei text-3xl text-dark-orange font-bold">
            Sobre
          </h3>
          <p className="text-start font-inter text-gray-600 lg:w-3/4">
      ...
      <div className="p-20 lg:px-40 bg-light-organge flex flex-col md:flex-row bg-light-blue justify-center items-center gap-10">
        ...
        <div className="flex flex-col items-end text-center gap-5">
          ...
          <p className="text-end font-inter text-gray-600 lg:w-3/4">
